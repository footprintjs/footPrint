...
`.contract(options)` attaches input/output schemas for validation and API generation. See [Self-describing APIs](/footPrint/guides/self-describing/) for the full guide.
