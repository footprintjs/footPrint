...
- [Filter Rules](https://footprintjs.github.io/footprint-playground/samples/filter-rules) — filter object rules with evidence (`creditScore gt 700 ✓` → approved)
- [Function Rules](https://footprintjs.github.io/footprint-playground/samples/function-rules) — function `when` clauses with read-tracking
- [Mixed Rules](https://footprintjs.github.io/footprint-playground/samples/mixed-rules) — filter + function rules in the same `decide()`
- [Select Parallel](https://footprintjs.github.io/footprint-playground/samples/select-parallel) — `select()` multi-match fires every matched branch in parallel
- [Decider (Conditional)](https://footprintjs.github.io/footprint-playground/samples/decider) — plain decider without `decide()`

→ Full guide: [Decision branching](/footPrint/guides/building-blocks/decisions/)
