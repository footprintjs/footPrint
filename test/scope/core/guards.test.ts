import { looksLikeClassCtor, looksLikeFactory, isSubclassOfStateScope } from '../../../src/scope/core/guards';
...
describe('guards', () => {
    ...
    test('isSubclassOfStateScope', () => {
        class MyScope extends BaseState { constructor(c:any,s:string,ro?:unknown){ super(c,s,ro); } }
