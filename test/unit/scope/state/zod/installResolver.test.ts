// Mock the providers registry BEFORE importing the installer
jest.mock('../../../../../src/scope/providers/resolve', () => ({
...
describe('zod/installResolvers', () => {
  beforeEach(() => {
    ...
    const { registerScopeResolver } = require('../../../../../src/scope/providers/resolve');
