...
import { PipelineStageFunction } from '../../src/core/executor/types';
...
describe('FlowChartExecutor Property-Based Tests', () => {
  ...
  describe('Property 2: Execution Semantics Preservation', () => {
    ...
    it('run() produces consistent results across multiple executions', async () => {
      await fc.assert(
        fc.asyncProperty(
          fc.string({ minLength: 1, maxLength: 50 }),
          async (output) => {
