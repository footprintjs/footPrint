...
import { CommitBundle, ExecutionHistory } from '../stateManagement/ExecutionHistory';
import { GlobalStore } from './GlobalStore';
import { StageContext, StageSnapshot } from './StageContext';
import type { FlowMessage } from '../pipeline/types';
...
/** @deprecated Use RuntimeSnapshot instead */
export type ContextTreeType = RuntimeSnapshot;
...
export class PipelineRuntime {
  ...
  /** @deprecated Use globalStore instead */
  public get globalContext(): GlobalStore {
    return this.globalStore;
  }
  /** @deprecated Use executionHistory instead */
  public get pipelineHistory(): ExecutionHistory {
